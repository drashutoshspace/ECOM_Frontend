							...
							<div className="col-lg-6 col-md-6" onMouseEnter={handleChangeImage} onMouseLeave={handleChangeImage}>
								{isDesktopOrLaptop && (
									<div className="me-lg-0 mb-3 mb-lg-0 d-flex justify-content-center">
										<img src={changeImage ? "images/Boring_Stuff_Yellow.svg" : "images/Boring_Stuff_LightBlue.svg"} height="400px" className="loginsvg" alt="Boring_Policies" />
									</div>
								)}
								{isTabletOrMobile && (
									<div className="me-lg-0 mb-3 mb-lg-0 d-flex justify-content-center">
										<img src={changeImage ? "images/Boring_Stuff_Yellow.svg" : "images/Boring_Stuff_LightBlue.svg"} height="250px" className="loginsvg" alt="Boring_Policies" />
									</div>
								)}
							</div>
							<div className="col-lg-6 col-md-6" onMouseEnter={handleChangeImage} onMouseLeave={handleChangeImage}>
										...
										<>
											<div className="col-md-12 mt-4 mt-md-0 d-flex justify-content-center">
												<div className="card bgcolorgreyish border5px border-0 p-3 w-50 text-center">
													<Link to="/cancellationandrefunds" className="lightbluehover fontsize14 text-uppercase colorblue">
											...
											<div className="col-md-12 mt-4 mt-md-4 d-flex justify-content-center">
												<div className="card bgcolorgreyish border5px border-0 p-3 w-50 text-center">
													<Link to="/privacypolicy" className="lightbluehover fontsize14 text-uppercase colorblue">
														Privacy Policy
													</Link>
												</div>
											</div>
											<div className="col-md-12 mt-4 mt-md-4 d-flex justify-content-center">
												<div className="card bgcolorgreyish border5px border-0 p-3 w-50 text-center">
													<Link to="/termsandconditions" className="lightbluehover fontsize14 text-uppercase colorblue">
														Terms &amp; Conditions
													</Link>
												</div>
											</div>
											<div className="col-md-12 mt-4 mt-md-4 d-flex justify-content-center">
												<div className="card bgcolorgreyish border5px border-0 p-3 w-50 text-center">
													<Link to="/faqs" className="lightbluehover fontsize14 colorblue">
														FAQs
													</Link>
												</div>
											</div>
