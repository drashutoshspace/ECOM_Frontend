		...
		<>
			...
			<Base>
				...
				<div className="container mb-2">
					<div className="row">
						<div
							className="col-lg-12 py-2 d-flex justify-content-center"
						...
						>
							<img
								...
								src={
									changeImage
										? "images/404_Error/404_Yellow.svg"
										: "images/404_Error/404_LightBlue.svg"
								}
								className="loginsvg"
								alt="404_1"
							/>
						...
						<div className="col-lg-12 pt-3 pb-4 d-flex justify-content-center">
							<img
								width="300px"
								src="images/404_Error/404_Text.svg"
								alt="404_2"
							/>
						</div>
					</div>
