				...
				<div className="container">
					<div className="row align-items-center pb-4">
						<div className="col-lg-6 col-md-6" onMouseEnter={handleChangeImage} onMouseLeave={handleChangeImage}>
							{isDesktopOrLaptop && (
								<div className="">
									<img src={changeImage ? "images/Login_SVG_Yellow.svg" : "images/Login_SVG_LightBlue.svg"} height="400px" className="loginsvg" alt="Login_SVG" />
								</div>
							)}
							{isTabletOrMobile && (
								<div className="mb-5 text-center">
									<img src={changeImage ? "images/Login_SVG_Yellow.svg" : "images/Login_SVG_LightBlue.svg"} width="300px" className="loginsvg" alt="Login_SVG" />
								</div>
							)}
						</div>
